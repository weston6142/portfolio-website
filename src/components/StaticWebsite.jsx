...
const StaticWebsite = () => {
  ...
  const [strokeColor, setStrokeColor] = useState(theme.colors.white);

  // add useEffect to change stroke color on hoverIndex change

  useEffect(() => {
    if (hoverIndex === 0) {
      setStrokeColor(theme.colors.primary);
    ...
    <ThemeProvider theme={theme}>
      <MainDiv>
        ...
        <RightDiv>
          <BioSection>
            {" "}
            My foray into the tech realm began at Penn State in 2014 when I
            headed to college for a degree in Petroleum Engineering. A gen-ed
            c++ class opened up a new world for me, and before I knew it, I was
            devouring Python in my spare time. I originally had a particular
            penchant for web scraping. Even with a freshly minted Petroleum
            Engineering degree, I knew I wanted my career to weave through code,
            not oil fields. <br></br> <br></br>Starting as a{" "}
            ...
            robots. That's where Python became more than a hobby, putting
            together an automated support system using a Slack bot and AWS
            ...
            robots and code, that I decided to mesh my tech skills with a
            personal interest in sports betting. Tinkering away, I built the
            first U.S. Sports Betting Arbitrage site using Python and cloud
            computing automation. It felt like I was hitting a sweet spot, and
            soon I had 16 paying monthly subscribers, each seeking to make
            smarter bets with my website. <br></br>
            ...
            in revenue, and I had the opportunity to travel the world. I dive
            into everything from data pipeline construction,{" "}
            <BioLinks href="https://www.youtube.com/watch?v=2MQsj-3rhMQ&ab_channel=GeckoRobotics">
              asset visualization web apps
            </BioLinks>
            , firmware, and getting hands-on with a tech-stack that spans from
            the familiar Python to TypeScript, React, and beyond. <br></br>{" "}
            <br></br>
            Life isn't all code though. Away from the screen, I'm usually
            hanging out with my friends, wife, and beagle Rusty around
            Pittsburgh, lacing up for a run, traveling, or tackling the latest
            home improvement quest.
          </BioSection>
          <Break />
          <ExperienceSection>
            <ExperienceCard
            ...
            >
              ...
              <ExperienceCardDiv>
                ...
                <ExperienceCardDescription>
                  ...
                  React application with a Python Flask backend that culminated
                  in a $50,000 prize at a Navy competition. I pioneered the
                  development of a 3D app leveraging React-Three-Fiber to
                  generate digital twin visualizations for enhancing asset
                  inspections. My efforts directly strengthened the execution
                  and delivery of Navy contracts, contributing over $1M in
                  customer value.
                </ExperienceCardDescription>
                <ExperienceCardLinks>
                  <ExperienceCardLink>
            ...
            >
              ...
              <ExperienceCardDiv>
                ...
                <ExperienceCardDescription>
                  ...
                  formulated key SOP documents and automated field-issue
                  reporting using AWS Lambda within our cloud architecture.
                </ExperienceCardDescription>
                <ExperienceCardSkills>
                  <ExperienceCardSkill>Python</ExperienceCardSkill>
          ...
          <ExperienceSection>
            <ExperienceCard>
              ...
              <ExperienceCardDiv>
                ...
                <ExperienceCardDescription>
                  I founded surefirebetting.com, which was the first U.S.
                  focused sports betting arbitrage website. Sports betting
                  arbitrage is a way to make guaranteed money by betting on both
                  sides of a match where two different sportsbooks disagree on
                  the outcome.
                  <br></br>
                  <br></br> The service, which peaked at 16 paying monthly
                  subscribers, was powered by my custom Python-driven web
                  scraping and cloud solutions, ensuring timely and accurate
                  arbitrage opportunities updated every minute.
                </ExperienceCardDescription>
              </ExperienceCardDiv>
            </ExperienceCard>
          </ExperienceSection>
